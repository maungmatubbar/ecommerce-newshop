                    ...
                    <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                        <div class="grid-arr">
                            <div  class="grid-arrival">
                                <figure>
                                    <a href="{{route('product-details',['product_id'=>$newProduct->id,'name'=>$newProduct->product_name])}}" class="new-gri" >
                                        <div class="grid-img">
                            ...
                            <div class="women">
                                ...
                                <p ><em class="item_price">BDT {{$newProduct->product_price}}</em></p>
